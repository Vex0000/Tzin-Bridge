...
public class Skeleton : FreeEntity
{
    ...
    public override void ProcessTurn()
    {
        ...
        GameAction attackPlayer = availableInnateActions.Find(x => x.ACTIONID == 7); 
        if (Vector3.Distance(transform.position, player.transform.position) < attackPlayer.actionRange/2)
        {
